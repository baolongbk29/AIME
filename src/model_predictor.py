...
class PredictorApi:
    def __init__(self, predictor_prob_1: ModelPredictor, predictor_prob_2: ModelPredictor):
        self.predictor_prob_1 = predictor_prob_1
        self.predictor_prob_2 = predictor_prob_2
        self.app = FastAPI()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_path_prob_1", type=str, default=default_config_path)
    parser.add_argument("--config_path_prob_2", type=str, default=default_config_path)
    parser.add_argument("--port", type=int, default=PREDICTOR_API_PORT)
    args = parser.parse_args()

    predictor_prob_1 = ModelPredictor(config_file_path=args.config_path_prob_1)
    predictor_prob_2= ModelPredictor(config_file_path=args.config_path_prob_2)

    api = PredictorApi(predictor_prob_1, predictor_prob_2)
